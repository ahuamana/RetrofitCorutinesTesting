...
class MainViewModelTest {
    ...
    @Test
    fun `check hourly size remote with local response`(){
        runBlocking {
            ...
            val localResult = JSONFileLoader().loadWeatherForecastEntity("weather_forecast_response_sucess")

           //compare remoteResult with localResult
